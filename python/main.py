...
from write_into_excel import write_four_features_into_excel
from final_clean import final_clean_func
from calculate_length import calculate_length_fucs
...
if __name__ == '__main__':
	...
	time_periods = { "atmo1": [["2015/8/25","2015/9/2"], ["2016/2/27", "2016/3/4"]], 
				...
				"atmo4": [["2016/3/31", "2016/4/11"], ["2017/1/24", "2017/1/31"]],
	...
	calculate_length_fucs(f_project_path, "four_features_summer", house_id_list, time_periods)
	calculate_length_fucs(f_project_path, "four_features_winter", house_id_list, time_periods)
